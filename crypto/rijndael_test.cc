...
// These tests are bassed in NESSIE test for Rijndael, they test different key
// values, IV values,
TEST(Rijndael256CFB, RandomIV) {
  const std::vector<std::string> iv = {
    {
      ...
      -54, 25, -68, -126, 58, 39, -93, -72,
      120, 109, 110, -88, 101, 50, 56, 122,
      -39, 38, -37, -3, -8, 62, -102, 94,
      -73, 101, -20, -116, -106, -38, -119, -7,
    }, {
      48, -95, -124, -122, 40, 21, 65, 50,
      -46, 70, -19, 33, 31, -104, 52, 94,
      60, 0, 58, -51, -14, 45, 29, -46,
      92, -125, -87, 80, 59, -34, 31, 58,
    },
  };
  ...
  const std::vector<std::string> cipher = {
    {
      ...
      62, 83, 15, -22, -72, -62, 103, -23,
      114, -13, 22, 47, 46, 117, -28, 93,
      82, -113, -115, 106, -115, -97, -47, -45,
      -118, 76, 31, -73, -19, 82, 18, -126,
    }, {
      65, 37, 63, 9, -102, 68, -104, 125,
      -22, -99, -29, 8, 113, 37, -102, 92,
      58, 54, -106, -67, 53, -114, -12, 27,
      116, -65, -77, 5, 22, 90, -51, -53,
    }, {
      102, -112, 83, -119, 123, 47, -56, 66,
      -63, 110, 119, -23, -106, -124, -94, 84,
      -57, 13, 15, -17, 81, 126, -100, 121,
      91, -22, -32, 62, 78, -124, -103, -40,
    }, {
      71, 127, 50, -119, 47, 41, -6, 21,
      -65, -68, 86, 77, 54, 47, 22, -20,
      111, -94, 98, -31, -5, 108, -89, 73,
      -62, 40, -49, 5, -69, -103, 108, 81,
    }
  };

  std::string key0(32, '\0');
  std::string plain_text0(32, '\0');

  for (int i(0); i < cipher.size(); ++i) {
    std::string result;

    Rijndael r(key0, iv[i]);
    r.Encrypt(plain_text0, result);

    ASSERT_TRUE(result.compare(cipher[i]) == 0);
  }
}
